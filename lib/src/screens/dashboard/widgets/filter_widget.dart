...
class FilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double maxHeight = MediaQuery.of(context).size.height * 0.8; // 最大高度为屏幕的 80%
        ...
        Padding(
          ...
          child: ClipRRect(
            ...
            child: Container(
              ...
              constraints: BoxConstraints(maxHeight: maxHeight), // 限制最大高度
              child: SingleChildScrollView( // 让内容可以滚动
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      shrinkWrap: true, // 让 ListView 适应内容
                      physics: NeverScrollableScrollPhysics(), // 禁止内部滚动，交给外部滚动
